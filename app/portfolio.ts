...
export const companies: Company[] = [
  ...
  { name: "Zero Carbon Labs", description: "We build climate technology.", category: "Software Development", year: "2016", url: null, logoPath: "/logos/zcl-Icon.svg", enabled: true, placeholder: false },
